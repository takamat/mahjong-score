...
var YakuhaiEast = (function (_super) {
    ...
    YakuhaiEast.prototype.isConditionMet = function () {
        return (this.hand.koutsuKantsuList.findIndex(function (mentsu) { return mentsu.tile === tile_1.Tile.Ton; }) >= 0);
    };
    return YakuhaiEast;
}(yaku_1.Yaku));
exports.YakuhaiEast = YakuhaiEast;
