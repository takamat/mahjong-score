...
var Hand = (function () {
    function Hand(tiles, juntou) {
        ...
        this.jantou = null;
        this.tiles = tiles;
        var copiedTiles = tiles.slice();
        var choseJantou = copiedTiles.splice(juntou[1], 1);
        choseJantou.concat(copiedTiles.splice(juntou[0], 1));
        this.jantou = mentsuUtils_1.getToitsu(choseJantou);
        var groups = lodash_groupby_1.default(copiedTiles, 'tile');
